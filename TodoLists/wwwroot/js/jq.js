...
if (typeof String.prototype.html != 'function') {
    String.prototype.html = function (it) { return this.replace(/[<]/g, "&lt;").replace(/[>]/g, "&gt;").replace(/\n/g, "<br/>"); };
}

if (typeof String.prototype.shorten != 'function') {
    String.prototype.shorten = function (maxLength, endWith) {
        return this.length > maxLength ? this.substring(0, maxLength) + (endWith || "...") : this;
    };
}
