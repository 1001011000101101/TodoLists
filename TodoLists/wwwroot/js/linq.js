...
Array.prototype.select.fn = function (d) {
    var fn = function () {
        this.select(d);
    };
    return fn;
...
Array.prototype.removeElements = function (its) {
    for (var i = 0; i < its.length; i++) {
        this.removeElement(its[i]);
    }
};
Array.prototype.removeEls = Array.prototype.removeElements;
